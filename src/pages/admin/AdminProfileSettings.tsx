      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="col-span-1 md:col-span-3">
          <CardHeader>
            ...
            <CardDescription>
              Configure your admin account settings
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  Your admin account has full access to all system features
                </p>
              </div>
            </div>
          </CardContent>
          <CardFooter>
            <p className="text-sm text-gray-500">
              For security reasons, some admin settings can only be changed by a super administrator
            </p>
          </CardFooter>
        </Card>
      </div>
